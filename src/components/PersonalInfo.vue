          ...
          <div class="content">
            ...
            <b-row 
                ...
                <b-row class="conent-bottom w-100">
                  <b-col>
                    <img
                      @click="openConfirmModal(conentItem.id)"
                      id="likeImg"
            ...
            <!-- 我的浏览 Start -->
             ...
             <b-row 
                ...
                <b-row class="conent-title w-100 text-left">
                  <a 
                  @click="toLive(conentItem.announcementId)"
     ...
     >
      ...
      <div class="d-block text-center">
       ...
       <div slot="modal-footer" class="w-100 text-center">
         <b-btn size="md" type="button" @click="showTipModal=false"
          variant="danger">好的
         </b-btn>
      </div>
     </b-modal>
  ...
  export default{
    ...
    methods:{
      ...
      toLive:function(id){
        ...
        dataType: 'json'
          ...
          if(data.data.state == "error") {
            ...
            this.queryContent(1,this.groupId,token);
            }
        }.bind(this))
          .catch(function(err){
          console.log("err:"+err)
      ...
      selectMyFcous:function(){
        ...
        this.seenSee=false;
        this.seenMes=false;
        var groupId = this.focusList[0].id;
        this.selectFcous(groupId,0);
      },
       /*切换到我的收藏*/
        ...
        this.$ajax({
          ...
          dataType: 'json'
            ...
            if(data.data.state == "erroruserservice") {
              ...
              /*判断总数的数量是否为0*/
              data.totalElements==0?this.isNull=true:this.isNull=false;

<template>
		<div class="page-header text-left">
            ...
            <b-nav>
             	...
             	<li>
             		<a   @click="showMyfoucs" @mouseover="toPointer($event)">我的关注</a>
             	</li>
             	<li>
             		<a   @click="showRecommend" @mouseover="toPointer($event)">推荐项目</a>
             	</li>
             	<li>
             		<a   @click="showDataProcess" @mouseover="toPointer($event)">数据处理</a>
             	</li>
            </b-nav>
...
<script >
	...
	export default{
		...
		methods:{
	      ...
	      showMyfoucs:function(){

	      },
	      showRecommend:function(){

	      },
	      showDataProcess:function(){
